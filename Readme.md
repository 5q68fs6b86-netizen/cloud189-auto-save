...
### 资源发现与转存
- **影巢资源**：支持影巢关键词搜索、TMDB 资源查询、免费资源识别与天翼分享解析。
- **Browser Bridge**：通过常驻浏览器保持影巢网页登录态，支持签到、积分日志、资源详情读取与解锁。
- **安全解锁**：免费资源可直接读取已解锁天翼信息，付费或积分未知资源会二次确认，避免误扣积分。
- **一键转存**：解析到天翼分享后可直接带入转存任务，衔接 STRM、追更与媒体库刷新流程。
- **Cloudsaver**：推荐使用修改过的cloudsaver https://github.com/wobuhui666/CloudSaver 支持搜索雷鲸小站和云巢的资源
...
- **影巢资源**：支持影巢搜索、网页登录取 Cookie、Browser Bridge、免费资源识别、积分解锁确认与一键转存
